...
function addItem(e) {
    ...
    deleteButton.className = "m-1 pb-1  btn btn-outline-danger float-end delete";

    deleteButton.appendChild(document.createTextNode("Delete"));

    let editButton = document.createElement('button');
    editButton.className = "m-1 pb-1 btn btn-outline-success float-end edit";
    ...
    document.getElementById("lblsuccess").innerHTML = "Text Added successfully";
    document.getElementById("lblsuccess").style.display = "block";
    setTimeout( function(){ document.getElementById("lblsuccess").style.display = "none"; } ,3000);	
